    ...
    return (
        <div>
            <div className="container">
                <h2 className='text-center mb-5'>Why Choose Royal University of Phnom Penh?</h2>
                <div className='row g-4'>
                        ...
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-center'>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora vero optio laudantium sint velit dignissimos, similique quas cupiditate asperiores voluptates?
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
                    ...
                    <div className='col-lg-4'>
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                <Card.Title className='text-center text-capitalize mb-3'>
                                    Big Campus suitable for studying
                                </Card.Title>
                                <Card.Text className='text-center'>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora vero optio laudantium sint velit dignissimos, similique quas cupiditate asperiores voluptates?
                                </Card.Text>
